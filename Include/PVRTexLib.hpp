...
namespace pvrtexlib
{
	...
	*************************************************************************/
	...
	public:
		...
		*************************************************************************/
		inline PVRTuint32 GetTextureWidth(PVRTuint32 mipLevel) const;
		...
		*************************************************************************/
		inline PVRTuint32 GetTextureHeight(PVRTuint32 mipLevel) const;
		...
		*************************************************************************/
		inline PVRTuint32 GetTextureDepth(PVRTuint32 mipLevel) const;
		...
		*************************************************************************/
		inline PVRTuint32 GetTextureDataSize(PVRTint32 mipLevel = PVRTEX_ALLMIPLEVELS, bool allSurfaces = true, bool allFaces = true) const;
	...
	*************************************************************************/
	...
	PVRTuint32 PVRTextureHeader::GetTextureDataSize(PVRTint32 mipLevel, bool allSurfaces, bool allFaces) const
	{
		if (m_hTextureHeader)
		{
