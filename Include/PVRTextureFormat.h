...
namespace pvrtexture
{
	...
	/*!***********************************************************************
	 @Function		charToEnum
	 @Input			c
	 @Return		EChannelName An enum equivalent of the char passed.
	 @Description	Maps a channel character to its enum equivalent. E.g. 'r' becomes eRed
	*************************************************************************/
	extern EChannelName charToChannelName(char c);

	/*!***********************************************************************
	 @Function		enumToChar
	 @Input			e
	 @Return		uint8 A char equivalent of the enum passed.
	 @Description	Maps a channel enum to its character equivalent. E.g. eRed becomes 'r'
	*************************************************************************/
	extern char channelNameToChar(EChannelName e);
	...
	extern int getNumChannels(PixelType pixelType);
	extern int getPixelTypeSize(PixelType pixelType);
	extern bool hasPackedChannelData(PixelType pixelType);
}
